...
import com.ignoransel.whimsicalideas.content.hex.buff.*;
...
public final class WIStatusEffects {
    ...
    public static final StatusEffect REFINE = new RefineStatusEffect();
    public static final StatusEffect REGENERATION = new RegenerationStatusEffect();
    public static void init() {
        ...
        Registry.register(Registries.STATUS_EFFECT, new Identifier("whimsical-ideas", "refine"), REFINE);
        Registry.register(Registries.STATUS_EFFECT, new Identifier("whimsical-ideas", "regeneration"), REGENERATION);
    }
}
